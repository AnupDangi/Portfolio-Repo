            ...
            <div className="flex flex-col md:flex-row gap-12 lg:gap-20">
                ...
                >
                    <div className="space-y-4 text-foreground/80 text-lg leading-relaxed">
                        <p>
                            I am a <strong className="text-foreground font-semibold">Full Stack AI Engineer</strong> passionate about building products that
                            help human lives. Currently, I am expanding my expertise in <span className="text-neon font-semibold">Deep Learning,
                    ...
                    <motion.div
                        ...
                        className="bg-surface border border-surface-border rounded-2xl p-6 shadow-2xl backdrop-blur-sm relative overflow-hidden group"
                    >
                        {/* Inner hover glow */}
                        <div className="absolute inset-0 bg-neon/5 opacity-0 group-hover:opacity-100 transition-opacity duration-500" />

                        <h3 className="text-xl font-bold text-foreground mb-2 relative z-10 flex items-center gap-2">
                        ...
                        <p className="text-text-muted relative z-10 leading-relaxed">
                            4th Year BE AIML <br />
                            <span className="text-foreground/90 font-medium">CMRIT College of Engineering</span> <br />
                            Bengaluru, India
                        </p>
                    </motion.div>
                </motion.div>
                ...
                <div className="flex-1">
                    ...
                    >
                        ...
                        <motion.span
                            ...
                            className="px-3 py-1 bg-surface border border-surface-border rounded text-sm font-medium text-text-muted hover:text-foreground flex items-center transition-colors shadow-sm"
                        >
                            + many more
                        </motion.span>
                    </motion.div>
